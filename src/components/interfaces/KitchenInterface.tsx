...
//     <span className="w-2 h-12 mr-3 bg-yellow-500 rounded"></span> {/* Left color bar */}
...
//                       </h3>
//                       <p className="text-sm text-muted-foreground">{order.created_at.toDate().toLocaleTimeString()}</p>
//                     </div>
